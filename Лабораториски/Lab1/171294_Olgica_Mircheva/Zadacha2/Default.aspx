...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <asp:Button ID="btnVreme" runat="server" Font-Names="Arial" Font-Size="Medium" ForeColor="Navy" OnClick="Click" Text="Контрола за приказ на време" />
        <asp:HyperLink ID="hlSledno" runat="server" NavigateUrl="~/Default2.aspx">Следно</asp:HyperLink>
    </div>

    <div class="row">
        <div class="col-md-4" style="left: 0px; top: 25px">
